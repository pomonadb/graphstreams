...
directed network, the number of edges of the form $e = (u,v)$ is the same
as the number of edges of the form $e' = (v,u)$, with $\T(e) = \T(e')$ and
 $\W(e) = \W(e')$ then pair up these edges; otherwise there is no transformation.
