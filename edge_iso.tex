...
\reminder{how do we store the node label of the original graph $G$ in $I_c(G)$? we can restore all the identification of the nodes, but can we also restore the node labels?}
